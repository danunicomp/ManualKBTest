...
${OBJECTDIR}/_ext/1543287360/showkey.o: /root/NetBeansProjects/ManualKBTest/showkey.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1543287360
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1543287360/showkey.o /root/NetBeansProjects/ManualKBTest/showkey.c
...
${OBJECTDIR}/beeptest.o: beeptest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/beeptest.o beeptest.cpp
...
${OBJECTDIR}/getwse.o: getwse.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/getwse.o getwse.cpp
