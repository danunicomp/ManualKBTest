...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/manualkbtest
OUTPUT_BASENAME=manualkbtest
PACKAGE_TOP_DIR=manualkbtest/
...
copyFileToTmpDir "/home/pi/ManualKBTest/config.txt" "${NBTMPDIR}/${PACKAGE_TOP_DIR}config.txt" 0644
